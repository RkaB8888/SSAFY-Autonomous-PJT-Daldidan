# ai/services/model_jhg3/extract_valid_embeddings.py
import json, pathlib, glob
import numpy as np, tqdm
from PIL import Image, ImageDraw
from torch.utils.data import Dataset, DataLoader

from services.model_jhg3.config import CACHE_DIR, VALID_IMAGES_DIR, VALID_JSONS_DIR
...
class CroppedDataset(Dataset):
    def __init__(
        ...
        for img_p, js_p in raw_pairs:
            ...
            if coll.get("sugar_content") is not None:
    ...
    def __getitem__(self, idx):
        ...
        try:
            ...
            if not seg:
                print(f"[Skip] segmentation 없음: {js_p.name}")
                return None
