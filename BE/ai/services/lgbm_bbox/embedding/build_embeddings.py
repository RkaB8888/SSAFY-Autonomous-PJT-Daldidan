# services/lgbm_bbox/embedding/build_embeddings.py
import argparse
import json
import pathlib
import numpy as np
...
import services.lgbm_bbox.config as cfg
from services.lgbm_bbox.utils.cropper import crop_apple
from services.lgbm_bbox.extractor.feature_extractors import extract_features
from services.lgbm_bbox.embedding.embedding_dispatcher import extract_embedding
