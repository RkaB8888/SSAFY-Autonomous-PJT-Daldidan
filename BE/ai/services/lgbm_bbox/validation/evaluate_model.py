# services/lgbm_bbox/validation/evaluate_model.py
"""
...
from services.lgbm_bbox.utils.loader import load_model_bundle
from services.lgbm_bbox.embedding import build_embeddings as beb  # ⬅️ 새 임베딩 모듈
...
def main():
    ...
    out_csv = Path("services/lgbm_bbox/eval_results.csv")
