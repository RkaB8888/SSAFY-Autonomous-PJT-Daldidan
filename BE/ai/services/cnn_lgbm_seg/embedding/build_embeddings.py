# services/cnn_lgbm_seg/embedding/build_embeddings.py
import argparse
import json
import pathlib
import numpy as np
...
import services.cnn_lgbm_seg.config as cfg
from services.cnn_lgbm_seg.utils.cropper import crop_apple
from services.cnn_lgbm_seg.extractor.feature_extractors import extract_features
from services.cnn_lgbm_seg.embedding.embedding_dispatcher import extract_embedding
