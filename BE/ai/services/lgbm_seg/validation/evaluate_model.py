# services/lgbm_seg/validation/evaluate_model.py
"""
...
from services.lgbm_seg.embedding import build_embeddings as beb  # ⬅️ 새 임베딩 모듈
...
def main():
    ...
    out_csv = Path("services/lgbm_seg/eval_results.csv")
