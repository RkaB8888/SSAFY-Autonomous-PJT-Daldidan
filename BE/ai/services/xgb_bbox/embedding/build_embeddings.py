# ai/services/xgb_bbox/embedding/build_embeddings.py
...
from services.xgb_bbox.config import (
    IMAGES_DIR,
    JSONS_DIR,
    VALID_IMAGES_DIR,
    VALID_JSONS_DIR,
...
from services.xgb_bbox.utils.cropper import crop_apple
from services.xgb_bbox.extractor.common_features import extract_features
