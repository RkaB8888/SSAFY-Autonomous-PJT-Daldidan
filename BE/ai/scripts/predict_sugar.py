#!/usr/bin/env python
# services/model_jhg2/predict/predict_sugar.py
"""
CLI 배치 예측 스크립트
------------------------------------------------
예시
...
from services.model_jhg2.config import MODEL_SAVE_PATH  # 기본 모델 경로
from ai.services.model_jhg2.predict.predictor import predict_bytes  # 공식 예측 함수
